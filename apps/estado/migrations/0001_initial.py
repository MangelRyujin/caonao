    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estado.typeservicepoblation', verbose_name='Tipo de servicio')),
            ],
            options={
